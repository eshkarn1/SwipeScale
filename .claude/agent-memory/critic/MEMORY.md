...
- [port-1 QA artefacts + node PATH](reference-port-1-qa-artefacts.md) — PATH/port/Lighthouse incantations, frame scripts, and two traps that fake contrast and type errors
